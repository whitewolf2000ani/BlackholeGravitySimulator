...
BG = pygame.transform.scale(
    pygame.image.load("cris-baron-AIOojVGUua8-unsplash.jpg"), (WIDTH, HEIGHT)
)
PLANET = pygame.transform.scale(
    pygame.image.load("—Pngtree—yellow black hole_4491995.png"),
...
def main():
    ...
    while running:
        ...
        for obj in objects[:]:
            ...
            collided = (
                math.sqrt((obj.x - planet.x) ** 2 + (obj.x - planet.y) ** 2)
                <= PLANET_SIZE
            )
